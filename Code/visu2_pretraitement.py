...
def get_data(data_teams_attack: pd.DataFrame,
    ...
    new_df_defense['Buts non reçus'] = new_df_defense['Buts non reçus'].max(
    ) - new_df_defense['Buts non reçus']
    new_df_defense['Passes adv. contrées'] = new_df_defense['Passes adv. contrées'].max(
    ) - new_df_defense['Passes adv. contrées']
    new_df_defense['Buts hors pénalty non reçus'] = new_df_defense['Buts hors pénalty non reçus'].max(
